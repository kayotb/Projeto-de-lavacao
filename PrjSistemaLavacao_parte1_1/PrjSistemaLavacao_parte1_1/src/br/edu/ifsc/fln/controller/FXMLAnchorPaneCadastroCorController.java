...
public class FXMLAnchorPaneCadastroCorController implements Initializable {
    ...
    @FXML
    private TableView<Cor> tableViewCors;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tableViewCors.getSelectionModel().selectedItemProperty().addListener(
    ...
    public void carregarTableViewCor() {
        ...
        observableListCors = FXCollections.observableArrayList(listaCors);
        tableViewCors.setItems(observableListCors);
    }
...
//        Cor cor = tableViewCors.getSelectionModel().getSelectedItem();
//        if (cor != null) {
//            boolean btConfirmarClicked = showFXMLAnchorPaneCadastroCorDialog(cor);
//            if (btConfirmarClicked) {
//                corDAO.alterar(cor);
